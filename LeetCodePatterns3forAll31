 ...
 * Comprehensive guide to coding interview patterns
...
public class LeetCodePatterns {
    ...
    public static void main(String[] args) {
        System.out.println("LeetCode Patterns Collection - 31 Patterns, 93 Problems");
        System.out.println("Run individual pattern tests from their respective methods");
    }
...
/**
 * SUMMARY:
 * This file contains 31 coding patterns with 3 problems each (93 total problems)
 * Each pattern addresses specific problem-solving techniques used in technical interviews
 * <p>
 * PATTERNS COVERED:
 * 1. Two Pointers         11. Tree BFS             21. Greedy Algorithms
 * 2. Fast & Slow Pointers 12. Tree DFS             22. 0/1 Knapsack (DP)
 * 3. Sliding Window       13. Graphs               23. Fibonacci (DP)
 * 4. Merge Intervals      14. Island (Matrix)      24. Palindromic Subsequence (DP)
 * 5. Cyclic Sort          15. Two Heaps            25. Backtracking
 * 6. LinkedList Reversal  16. Subsets              26. Trie
 * 7. Stack                17. Modified Binary Search 27. Topological Sort
 * 8. Monotonic Stack      18. Bitwise XOR          28. Union Find
 * 9. Hash Maps            19. Top K Elements       29. Ordered Set
 * 10. Level Order Traversal 20. K-way Merge        30. Prefix Sum
 * 31. Multi-thread
 * <p>
 * USAGE:
 * - Use as a reference for coding interview preparation
 * - Study patterns to recognize problem types
